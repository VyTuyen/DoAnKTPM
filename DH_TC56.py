### đặt hàng quốc tế thành công(ch đăng nhập)
...
driver.find_element(By.ID,'f-email').send_keys('143th@gmail.com')
...
driver.find_element(By.ID,'f-phone').send_keys('37567898')
