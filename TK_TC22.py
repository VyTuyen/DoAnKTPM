#Cập nhật tt tkhoan với sđt kh đúng định dạng
...
driver.find_element(By.ID, "customer_email").send_keys("1954052063ngan@gmail.com")
driver.find_element(By.ID, "customer_password").send_keys("kimngan250401")
...
driver.find_element(By.ID,'phone_ac').send_keys("023467")
